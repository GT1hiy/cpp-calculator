...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_plus->setMaximumSize(QSize(16777215, 60));

        gridLayout->addWidget(btn_plus, 7, 3, 1, 1);
        ...
        btn_dot->setMaximumSize(QSize(16777215, 60));

        gridLayout->addWidget(btn_dot, 8, 0, 1, 1);
        ...
        btn_minus->setMaximumSize(QSize(16777215, 60));

        gridLayout->addWidget(btn_minus, 6, 3, 1, 1);
        ...
        btn_divide->setMaximumSize(QSize(16777215, 60));

        gridLayout->addWidget(btn_divide, 3, 3, 1, 1);
        ...
        QWidget::setTabOrder(btn_change_sign, btn_divide);
        QWidget::setTabOrder(btn_divide, btn_7);
        ...
        QWidget::setTabOrder(btn_6, btn_minus);
        QWidget::setTabOrder(btn_minus, btn_1);
        QWidget::setTabOrder(btn_1, btn_2);
        QWidget::setTabOrder(btn_2, btn_3);
        QWidget::setTabOrder(btn_3, btn_plus);
        QWidget::setTabOrder(btn_plus, btn_dot);
        QWidget::setTabOrder(btn_dot, btn_0);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btn_divide->setText(QCoreApplication::translate("MainWindow", "\303\267", nullptr));
